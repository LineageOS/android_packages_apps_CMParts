...
public class ApplicationActivity extends PreferenceActivity implements OnPreferenceChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mForceEmmcPref.setChecked((SystemProperties.getInt("persist.vold.switchexternal", 0) == 1));
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mMoveAllAppsPref) {
            ...
            SystemProperties.set("persist.vold.switchexternal",
		mForceEmmcPref.isChecked() ? "1" : "0");
            return true;
        }
        return false;
    }
