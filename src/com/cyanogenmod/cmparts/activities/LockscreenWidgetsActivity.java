...
public class LockscreenWidgetsActivity extends PreferenceActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        CalendarEntries calEntries = findCalendars();
    ...
    private CalendarEntries findCalendars() {
    ...
    private static class CalendarEntries {
        ...
        CalendarEntries(List<CharSequence> mEntries, List<CharSequence> mEntryValues) {
