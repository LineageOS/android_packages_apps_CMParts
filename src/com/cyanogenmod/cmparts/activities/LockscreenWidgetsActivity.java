...
public class LockscreenWidgetsActivity extends PreferenceActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCalendarsPref.setEntries(findCalendars(Calendar.Calendars.DISPLAY_NAME));
        mCalendarsPref.setEntryValues(findCalendars(BaseColumns._ID));
    ...
    private CharSequence[] findCalendars(String projection) {
        List<String> calendars = new ArrayList<String>();
        Cursor cursor = null;
        try {
            cursor = Calendar.Calendars.query(getContentResolver(), new String[] {
                projection
        ...
        return calendars.toArray(new CharSequence[calendars.size()]);
    }
}
