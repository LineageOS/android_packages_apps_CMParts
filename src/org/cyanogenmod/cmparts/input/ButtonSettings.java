...
public class ButtonSettings extends SettingsPreferenceFragment implements
    ...
    private static final String KEY_NAVIGATION_BAR_HOME_LONG_PRESS = "navigation_bar_home_long_press";
    private static final String KEY_NAVIGATION_BAR_HOME_DOUBLE_TAP = "navigation_bar_home_double_tap";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mNavigationHomeLongPressAction = initActionList(KEY_NAVIGATION_BAR_HOME_LONG_PRESS, homeLongPressAction);

        // Navigation bar home double tap
        mNavigationHomeDoubleTapAction = initActionList(KEY_NAVIGATION_BAR_HOME_DOUBLE_TAP, homeDoubleTapAction);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mHomeLongPressAction || preference == mNavigationHomeLongPressAction) {
