...
public class NetworkTrafficSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mNetTrafficAutohide.setChecked((CMSettings.Secure.getInt(resolver,
        ...
        if (TrafficStats.getTotalTxBytes() != TrafficStats.UNSUPPORTED &&
            ...
            mNetTrafficVal = CMSettings.Secure.getInt(resolver,
    ...
    private void updateNetworkTrafficState(int index) {
        boolean b = index > 0;
        mNetTrafficPeriod.setEnabled(b);
        mNetTrafficAutohide.setEnabled(b);
        mNetTrafficAutohideThreshold.setEnabled(b);
    }
