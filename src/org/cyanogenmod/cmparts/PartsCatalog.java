        ...
        try {
            ...
            while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
                ...
                if ("part".equals(nodeName)) {
                    ...
                    String key = null;
                    TypedValue tv = sa.peekValue(com.android.internal.R.styleable.Preference_key);
                    ...
                    tv = sa.peekValue(com.android.internal.R.styleable.Preference_title);
                    if (tv != null && tv.type == TypedValue.TYPE_STRING) {
                        if (tv.resourceId != 0) {
                    ...
                    tv = sa.peekValue(com.android.internal.R.styleable.Preference_summary);
                    if (tv != null && tv.type == TypedValue.TYPE_STRING) {
                        if (tv.resourceId != 0) {
                    ...
                    info.setFragmentClass(sa.getString(com.android.internal.R.styleable.Preference_fragment));
                    info.setIconRes(sa.getResourceId(com.android.internal.R.styleable.Preference_icon, 0));
