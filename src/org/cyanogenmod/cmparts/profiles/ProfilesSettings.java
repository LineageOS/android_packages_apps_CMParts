...
public class ProfilesSettings extends SettingsPreferenceFragment
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case MENU_APP_GROUPS:
                startFragment(AppGroupList.class.getName(), null,
                        getResources().getString(R.string.profile_appgroups_title));
                return true;
        }
    ...
    private void addProfile() {
        ...
        pa.startPreferencePanel(SetupTriggersFragment.class.getCanonicalName(), args, null);
    }
