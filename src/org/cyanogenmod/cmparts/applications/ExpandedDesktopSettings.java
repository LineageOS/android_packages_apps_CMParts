...
import org.cyanogenmod.cmparts.SwitchBar;
...
public class ExpandedDesktopSettings extends SettingsPreferenceFragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.expanded_desktop_settings, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        mSwitchBar.setOnStateOffLabel(R.string.expanded_desktop_enabled_for_all_label);
        mSwitchBar.setOnStateOnLabel(R.string.expanded_desktop_enabled_for_all_label);
        mSwitchBar.show();

        mEmptyView = view.findViewById(R.id.nothing_to_show_text);
