...
public class CMPartsSearchIndexablesProvider extends SearchIndexablesProvider {
    ...
    public Cursor queryRawData(String[] strings) {
        ...
        for (String key : keys) {
            ...
            List<String> keywordList = sip.getSearchKeywords(getContext());
            ...
            ref[COLUMN_INDEX_RAW_INTENT_TARGET_PACKAGE] = CMPARTS_PACKAGE;
    ...
    public Cursor queryNonIndexableKeys(String[] strings) {
        ...
        for (String key : keys) {
            ...
            List<String> nik = sip.getNonIndexableKeys(getContext());
            if (nik == null) {
                continue;
            }
