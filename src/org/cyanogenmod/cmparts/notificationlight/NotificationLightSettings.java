...
public class NotificationLightSettings extends SettingsPreferenceFragment implements
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mLedCanPulse = nm.doLightsSupport(NotificationManager.LIGHTS_LED_PULSE);
        mMultiColorLed = nm.doLightsSupport(NotificationManager.LIGHTS_RGB_NOTIFICATION);
        ...
        if (!nm.doLightsSupport(NotificationManager.LIGHTS_ADJUSTABLE_NOTIFICATION_BRIGHTNESS)) {
        ...
        if (!nm.doLightsSupport(NotificationManager.LIGHTS_MULTIPLE_LED)) {
