...
public class BatteryLightSettings extends SettingsPreferenceFragment implements
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (!nm.doLightsSupport(NotificationManager.LIGHTS_LED_PULSE) ||
                nm.doLightsSupport(NotificationManager.LIGHTS_SEGMENTED_LED)) {
            mGeneralPrefs.removePreference(mPulseEnabledPref);
        }

        // Does the device support changing LED colors?
        if (nm.doLightsSupport(NotificationManager.LIGHTS_RGB_LED)) {
